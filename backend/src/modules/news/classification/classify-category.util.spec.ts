...
describe('classifyCategory', () => {
  ...
  it('classifies politics stories from keywords', () => {
    expect(classifyCategory({ title: 'Senate votes on new bill' })).toBe(
      'politics',
    );
  });
  ...
  it('considers the summary as well as the title', () => {
    expect(
      classifyCategory({
        ...
        summary:
          'Doctors warn of a new vaccine shortage at local hospitals.',
      }),
    ).toBe('health');
  });
  ...
  it('classifies a Sudan proxy-war report as politics', () => {
    expect(
      classifyCategory({
        ...
        summary:
          'Foreign military support and weapons supply lines continue to delay peace.',
      }),
    ).toBe('politics');
  });
  ...
  it('classifies Red Cross humanitarian reporting as health', () => {
    expect(
      classifyCategory({
        title:
          'Red Cross appeals for greater support as humanitarian needs deepen across Sudan',
        summary:
          'Humanitarian organizations warn that food and medical needs continue to grow.',
      }),
    ).toBe('health');
  });
  ...
  it('classifies a deadly military strike as politics', () => {
    expect(
      classifyCategory({
        ...
        summary:
          'The conflict involves the Sudanese military and paramilitary forces.',
      }),
    ).toBe('politics');
  });
  ...
  it('does not classify a surname-only result as politics or health', () => {
    expect(
      classifyCategory({
        title:
          "Rajouri Student Nikhil Sudan Features In Official Poster Of Youth Campaign",
        summary:
          'A Class XII student appeared in an official educational poster.',
      }),
    ).toBe('world');
  });
  ...
  it('gives title matches more weight than summary matches', () => {
    expect(
      classifyCategory({
        ...
        summary:
          'The announcement was shared through a digital technology platform.',
      }),
    ).toBe('politics');
  });
});