      ...
      <div className="mx-auto w-full max-w-cd-page px-cd-14 py-6 lg:px-cd-26">
        ...
        */}
        <div className="flex flex-wrap items-center gap-cd-12 rounded-cd-14 border border-cd-edge-structural bg-cd-fill-footer py-cd-6 pl-cd-10 pr-cd-18 lg:flex-nowrap lg:gap-cd-36 lg:rounded-cd-16 lg:border-cd-edge-card lg:px-cd-22 lg:py-cd-20">
          ...
          {/*
            GN-CD-202 -- the link row. Every group's links, flattened.

            THE ACCESSIBLE NAME NAMES THE NAVIGATION, NOT ONE OF ITS GROUPS.
            D-4 A originally required an EXISTING string here and
            `t.groupTitles.Legal` was chosen, which was accurate while Legal
            was the only group. The Support closure adds a Help group, so a
            landmark announced as "Legal" would then hand the reader Help
            links inside it. The CTO authorized exactly one new key for this
            -- `footer.navigationAriaLabel` -- and no other copy changed.
          */}
          <nav
            aria-label={t.navigationAriaLabel}
            className="flex flex-wrap items-center gap-cd-9 lg:gap-cd-22"
          >
