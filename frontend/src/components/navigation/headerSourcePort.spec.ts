...
describe('M66.2 — GN-CD-027 Sign In', () => {
  ...
  it('AccountControl still receives every one of its real behaviours by prop, unmodified', () => {
    for (const prop of [
      ...
      'historyLabel',
      'signOutLabel',
      // ACCOUNT DESTRUCTIVE-ACTION SAFETY: the two delete props were removed
      // with the destructive action they fed; this navigational prop replaces
      // them. Every OTHER behaviour in this list is still passed, unmodified.
      'settingsLabel',
    ]) {
