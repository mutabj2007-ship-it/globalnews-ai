  ...
  */
  ...
  const dockRegion = (
    ...
    >
      ...
      */}
      <div className={isPhone ? undefined : 'h-full min-h-0 overflow-y-auto'}>
      <SourcesReporting
        ...
        */
        ...
        /*
          ...
          a compact dock clips its overflow; the interior is given
          `overflow-y-auto` rather than `hidden` because the one failure
          this frame must never reproduce is content that exists and
          cannot be reached — 22px of this same dock was unreachable at
          375x844 before R1 ruling 1, and that is what produced the ruling
          being superseded here.
