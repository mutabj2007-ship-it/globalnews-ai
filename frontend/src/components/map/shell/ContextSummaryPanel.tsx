      ...
      {nothingAtAll ? (
        ...
        <>
          ...
          >
            ...
            <div className="bg-sp-panel-2 px-[10px] py-[9px]">
              <b data-gn="total-sources" className="block font-gn-mono text-[19px] font-medium text-sp-ink">
                {totals.recordCount}
              </b>
              <span className="font-gn-mono text-[8px] uppercase tracking-[0.12em] text-sp-ink-3">
                {labels.totalsSources}
              </span>
            </div>
            <div className="bg-sp-panel-2 px-[10px] py-[9px]">
              <b data-gn="total-geographies" className="block font-gn-mono text-[19px] font-medium text-sp-amber">
                {totals.geographyCount}
              </b>
              <span className="font-gn-mono text-[8px] uppercase tracking-[0.12em] text-sp-ink-3">
                {labels.totalsGeographies}
              </span>
            </div>
          </div>
