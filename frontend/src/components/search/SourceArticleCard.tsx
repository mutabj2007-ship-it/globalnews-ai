  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        <span className="mb-2 font-mono text-[12px] md:text-[11px] uppercase tracking-widest text-signal-bright">
          {article.category}
        </span>
        ...
        <div className="mt-auto flex flex-wrap items-center gap-2 font-mono text-[12px] md:text-[11px] text-ink-tertiary">
          <span className="text-ink-secondary">{article.sourceName}</span>
          <span aria-hidden="true">&middot;</span>
          {/* R4 GDELT — see SourcesDock. An observed timestamp is labelled
              as observed rather than presented as publication. */}
          <span>
            {formatObservationalTime(article.publishedAt, article.publishedAtBasis)}
          </span>
          {/*
