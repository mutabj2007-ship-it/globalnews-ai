...
/**
 * BETA-SIMPLE-ASK-SAND-1 §15/§17/§21 — the public /security route.
 *
...
export const metadata: Metadata = {
  title: 'Security — GlobalNews AI',
  description:
    'Current security developments, drawn from retrieved and cited sources.',
};
...
export default async function SecurityPage({
  ...
  return <BetaCategoryPage category="security" countryCode={searchParams?.country} />;
}
