...
/**
 * BETA-SIMPLE-ASK-SAND-1 §15/§17/§21 — the public /world route.
 *
...
export const metadata: Metadata = {
  title: 'World — GlobalNews AI',
  description:
    'Current world developments, drawn from retrieved and cited sources.',
};
...
export default async function WorldPage({
  ...
  return <BetaCategoryPage category="world" countryCode={searchParams?.country} />;
}
