...
/**
 * ════════════════════════════════════════════════════════════════════════════
 * ELECTION INTELLIGENCE — PROVIDER-FREE PREVIEW. NOT `/election`.
 * ════════════════════════════════════════════════════════════════════════════
 *
...
export default function ElectionVisualPreviewPage(): JSX.Element {
  const locale = electionLocale();
  return (
    <ScriptRun locale={locale} step="wrapping" as="div">
      <main style={{ minHeight: '100vh' }}>
        <ElectionPreviewScreen locale={locale} compact={false} />
      </main>
    </ScriptRun>
  );
}
