...
/**
 * BETA-SIMPLE-ASK-SAND-1 §15/§17/§21 — the public /energy route.
 *
...
export const metadata: Metadata = {
  title: 'Energy — GlobalNews AI',
  description:
    'Current energy developments, drawn from retrieved and cited sources.',
};
...
export default async function EnergyPage({
  ...
  return <BetaCategoryPage category="energy" countryCode={searchParams?.country} />;
}
