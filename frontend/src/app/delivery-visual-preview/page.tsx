...
/**
 * ════════════════════════════════════════════════════════════════════════════
 * DELIVERY INTELLIGENCE — PROVIDER-FREE PREVIEW. NOT `/delivery`.
 * ════════════════════════════════════════════════════════════════════════════
 *
...
export default function DeliveryVisualPreviewPage(): JSX.Element {
  const locale = deliveryLocale();
  return (
    <ScriptRun locale={locale} step="wrapping" as="div">
      <main style={{ minHeight: '100vh' }}>
        <DeliveryPreviewScreen locale={locale} compact={false} />
      </main>
    </ScriptRun>
  );
}
