...
type RetainedEconomyCopy = Readonly<Record<"name" | "published" | "statement" | "onePeriod" | "trend" | "source" | "jurisdiction" | "period" | "retrieved" | "licence" | "base" | "language" | "artifact" | "extractor" | "openSource" | "attentionEmpty" | "watched" | "policy" | "explain" | "revisions" | "readings" | "policyEvent" | "analyze" | "sources" | "timeline" | "noRanking" | "preview" | "observedScope" | "plannedScope", string>>;

const retainedCopy: Record<EconomyLocale, RetainedEconomyCopy> = {
  "en": {
    "name": "{country} Economy",
    "published": "published",
    "statement": "{authority} CPI {period}: {value}% year on year. One retained official observation; trend not established.",
    "onePeriod": "One retained period",
    "trend": "trend not available yet — not established",
    "source": "Source",
    ...
    "attentionEmpty": "No comparative assessment or attention ranking is available.",
    "watched": "watched",
    "policy": "Policy & release",
    "explain": "Explain triad",
    "revisions": "Revisions",
    "readings": "Competing readings",
    "policyEvent": "Policy event",
    "analyze": "Run analysis",
    "sources": "Sources · observation provenance",
    "timeline": "Timeline · retained release history",
    "noRanking": "No attention ranking · open retained sources below",
    "preview": "Alpha visual preview",
    "observedScope": "Observed scope",
    "plannedScope": "Planned visual scope"
  },
  "pl": {
    "name": "Gospodarka {country}",
    "published": "publ.",
    "statement": "CPI {authority} {period}: {value}% rok do roku. Jedna zachowana oficjalna obserwacja; trend nieustalony.",
    "onePeriod": "Jeden zachowany okres",
    "trend": "trend nieustalony",
    "source": "Źródło",
    "jurisdiction": "Obszar",
    "period": "Okres",
    "retrieved": "Zachowano",
    "licence": "Licencja",
    "base": "Baza indeksu",
    "language": "Język źródła",
    "artifact": "Dokument",
    "extractor": "Ekstraktor",
    "openSource": "Otwórz dokument źródłowy",
    "attentionEmpty": "Brak oceny porównawczej i rankingu uwagi.",
    "watched": "obserwowanych",
    "policy": "Polityka i publikacje",
    "explain": "Wyjaśnij porównanie",
    "revisions": "Wersje",
    "readings": "Różne interpretacje",
    "policyEvent": "Decyzja gospodarcza",
    "analyze": "Analizuj",
    "sources": "Źródła · pochodzenie obserwacji",
    "timeline": "Oś czasu · zachowane publikacje",
    "noRanking": "Brak rankingu uwagi · źródła poniżej",
    "preview": "Podgląd wizualny Alpha",
    "observedScope": "Zakres danych",
    "plannedScope": "Planowany zakres"
  },
  "fr": {
    "name": "Économie du {country}",
    "published": "publié",
    "statement": "IPC {authority} {period} : {value}% sur un an. Une observation officielle conservée ; tendance non établie.",
    "onePeriod": "Une période conservée",
    "trend": "tendance non établie",
    "source": "Source",
    "jurisdiction": "Territoire",
    "period": "Période de référence",
    "retrieved": "Récupéré",
    "licence": "Licence",
    "base": "Base de l’indice",
    "language": "Langue source",
    "artifact": "Document",
    "extractor": "Extracteur",
    "openSource": "Ouvrir le document source",
    "attentionEmpty": "Aucune évaluation comparative ni classement d’attention disponible.",
    "watched": "suivis",
    "policy": "Politique et publications",
    "explain": "Expliquer la comparaison",
    "revisions": "Révisions",
    "readings": "Interprétations concurrentes",
    "policyEvent": "Décision économique",
    "analyze": "Lancer l’analyse",
    "sources": "Sources · provenance de l’observation",
    "timeline": "Chronologie · publications conservées",
    "noRanking": "Aucun classement d’attention · sources ci-dessous",
    "preview": "Aperçu visuel Alpha",
    "observedScope": "Périmètre observé",
    "plannedScope": "Périmètre prévu"
  },
  "de": {
    "name": "Wirtschaft {country}s",
    "published": "veröffentlicht",
    "statement": "{authority}-VPI {period}: {value}% gegenüber dem Vorjahr. Eine gespeicherte amtliche Beobachtung; kein Trend belegt.",
    "onePeriod": "Ein gespeicherter Zeitraum",
    "trend": "kein Trend belegt",
    "source": "Quelle",
    "jurisdiction": "Gebiet",
    "period": "Bezugszeitraum",
    "retrieved": "Abgerufen",
    "licence": "Lizenz",
    "base": "Indexbasis",
    "language": "Quellsprache",
    "artifact": "Dokument",
    "extractor": "Extraktor",
    "openSource": "Quelldokument öffnen",
    "attentionEmpty": "Keine vergleichende Bewertung oder Aufmerksamkeitsrangfolge verfügbar.",
    "watched": "beobachtet",
    "policy": "Politik und Veröffentlichungen",
    "explain": "Vergleich erklären",
    "revisions": "Revisionen",
    "readings": "Konkurrierende Deutungen",
    "policyEvent": "Wirtschaftspolitisches Ereignis",
    "analyze": "Analyse starten",
    "sources": "Quellen · Herkunft der Beobachtung",
    "timeline": "Zeitachse · gespeicherte Veröffentlichungen",
    "noRanking": "Keine Aufmerksamkeitsrangfolge · Quellen unten",
    "preview": "Alpha-Vorschau",
    "observedScope": "Beobachteter Bereich",
    "plannedScope": "Geplanter Bereich"
  },
  "es": {
    "name": "Economía de {country}",
    "published": "publicado",
    "statement": "IPC {authority} {period}: {value}% interanual. Una observación oficial conservada; tendencia no establecida.",
    "onePeriod": "Un período conservado",
    "trend": "tendencia no establecida",
    "source": "Fuente",
    "jurisdiction": "Territorio",
    "period": "Período de referencia",
    "retrieved": "Recuperado",
    "licence": "Licencia",
    "base": "Base del índice",
    "language": "Idioma de la fuente",
    "artifact": "Documento",
    "extractor": "Extractor",
    "openSource": "Abrir documento fuente",
    "attentionEmpty": "No hay evaluación comparativa ni clasificación de atención.",
    "watched": "seguidos",
    "policy": "Política y publicaciones",
    "explain": "Explicar comparación",
    "revisions": "Revisiones",
    "readings": "Interpretaciones alternativas",
    "policyEvent": "Decisión económica",
    "analyze": "Ejecutar análisis",
    "sources": "Fuentes · procedencia de la observación",
    "timeline": "Cronología · publicaciones conservadas",
    "noRanking": "Sin clasificación de atención · fuentes abajo",
    "preview": "Vista previa Alpha",
    "observedScope": "Ámbito observado",
    "plannedScope": "Ámbito previsto"
  },
  "pt": {
    "name": "Economia do {country}",
    "published": "publicado",
    "statement": "IPC {authority} {period}: {value}% homólogo. Uma observação oficial conservada; tendência não estabelecida.",
    "onePeriod": "Um período conservado",
    "trend": "tendência não estabelecida",
    "source": "Fonte",
    "jurisdiction": "Território",
    "period": "Período de referência",
    "retrieved": "Obtido",
    "licence": "Licença",
    "base": "Base do índice",
    "language": "Idioma da fonte",
    "artifact": "Documento",
    "extractor": "Extrator",
    "openSource": "Abrir documento de origem",
    "attentionEmpty": "Sem avaliação comparativa ou classificação de atenção.",
    "watched": "seguidos",
    "policy": "Política e publicações",
    "explain": "Explicar comparação",
    "revisions": "Revisões",
    "readings": "Interpretações alternativas",
    "policyEvent": "Decisão económica",
    "analyze": "Executar análise",
    "sources": "Fontes · proveniência da observação",
    "timeline": "Cronologia · publicações conservadas",
    "noRanking": "Sem classificação de atenção · fontes abaixo",
    "preview": "Pré-visualização Alpha",
    "observedScope": "Âmbito observado",
    "plannedScope": "Âmbito previsto"
  },
  "ar": {
    "name": "اقتصاد {country}",
    "published": "نُشر",
    "statement": "مؤشر أسعار المستهلك {authority} {period}: {value}% سنوياً. رصد رسمي واحد محفوظ؛ الاتجاه غير مثبت.",
    "onePeriod": "فترة واحدة محفوظة",
    "trend": "الاتجاه غير مثبت",
    "source": "المصدر",
    "jurisdiction": "النطاق",
    "period": "الفترة المرجعية",
    ...
    "artifact": "الوثيقة",
    "extractor": "المستخرج",
    "openSource": "فتح وثيقة المصدر",
    "attentionEmpty": "لا يتوفر تقييم مقارن أو ترتيب للاهتمام.",
    "watched": "قيد المتابعة",
    "policy": "السياسة والمنشورات",
    "explain": "شرح المقارنة",
    "revisions": "المراجعات",
    "readings": "القراءات المتنافسة",
    "policyEvent": "قرار اقتصادي",
    "analyze": "تشغيل التحليل",
    "sources": "المصادر · أصل الرصد",
    "timeline": "الخط الزمني · المنشورات المحفوظة",
    "noRanking": "لا ترتيب للاهتمام · المصادر أدناه",
    "preview": "معاينة Alpha",
    "observedScope": "النطاق المرصود",
    "plannedScope": "النطاق المخطط"
  }
};
...
/** Copy for retained observations, separate from the frozen dashboard catalogue. */
export function retainedEconomyStrings(locale: EconomyLocale): RetainedEconomyCopy {
  return retainedCopy[locale];
}
